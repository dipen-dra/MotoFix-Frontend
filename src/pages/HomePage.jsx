...
//                 <div className="container mx-auto px-4">
//                     <h2 className="text-3xl font-bold text-center mb-12 text-slate-800">Why Choose MotoFix?</h2>
//                     <div className="grid md:grid-cols-3 gap-8 text-center">
//                         <div className="p-6 transition duration-300 hover:shadow-xl hover:scale-105 rounded-lg">
//                             <FeatureIcon><WrenchIcon /></FeatureIcon>
//                             <h3 className="text-xl font-semibold mb-2 text-slate-800">Expert Technicians</h3>
...
//                         <div className="p-6 transition duration-300 hover:shadow-xl hover:scale-105 rounded-lg">
//                             <FeatureIcon><PriceTagIcon /></FeatureIcon>
//                             <h3 className="text-xl font-semibold mb-2 text-slate-800">Transparent Pricing</h3>
//                             <p className="text-slate-600">
//                                 Get detailed upfront estimates with no surprises. Our commitment to clear pricing ensures complete trust, with a breakdown of services and no hidden charges—ever.
//                             </p>
//                         </div>
//                         <div className="p-6 transition duration-300 hover:shadow-xl hover:scale-105 rounded-lg">
//                             <FeatureIcon><TruckIcon /></FeatureIcon>
//                             <h3 className="text-xl font-semibold mb-2 text-slate-800">Pick-up & Drop</h3>
//                             <p className="text-slate-600">
//                                 Book your service online and we’ll take care of the rest. Our seamless pick-up and drop service is designed to give you maximum convenience and safety.
//                             </p>
//                         </div>
...
//                             <h3 className="text-xl font-bold mb-2 text-sky-600">General Service</h3>
//                             <p className="text-slate-600">
//                                 From oil changes to brake inspections, our general service covers every essential aspect to keep your bike in optimal condition and extend its lifespan.
//                             </p>
//                         </div>
//                          <div className="bg-white rounded-lg shadow-md p-6 text-center transform hover:-translate-y-2 transition-transform duration-300">
//                             <h3 className="text-xl font-bold mb-2 text-sky-600">Engine Repair</h3>
//                             <p className="text-slate-600">
//                                 Facing unusual noise or performance drops? Our engine experts diagnose and fix problems efficiently using high-quality parts and advanced diagnostic tools.
//                             </p>
//                         </div>
//                          <div className="bg-white rounded-lg shadow-md p-6 text-center transform hover:-translate-y-2 transition-transform duration-300">
//                             <h3 className="text-xl font-bold mb-2 text-sky-600">Denting & Painting</h3>
//                             <p className="text-slate-600">
//                                 Give your bike a makeover! We remove dents and provide precision paintwork using OEM-quality paints to restore that brand-new shine.
//                             </p>
//                         </div>
//                          <div className="bg-white rounded-lg shadow-md p-6 text-center transform hover:-translate-y-2 transition-transform duration-300">
//                             <h3 className="text-xl font-bold mb-2 text-sky-600">Insurance Claims</h3>
//                             <p className="text-slate-600">
//                                 We simplify the insurance process by assisting you with paperwork, damage evaluation, and claim processing—quick, easy, and worry-free.
//                             </p>
//                         </div>
...
//                  <div className="text-center">
//                     <h1 className="text-3xl md:text-4xl font-semibold text-slate-800">What Our Customers Say</h1>
//                     <div className="flex flex-wrap justify-center gap-5 mt-16 text-left">
//                         <div className="w-80 flex flex-col items-start border border-slate-200 p-5 rounded-lg bg-white hover:shadow-xl transition-shadow duration-300">
//                            <QuoteIcon />
//                             <div className="flex items-center justify-center mt-3 gap-1">
//                                 <StarIcon /><StarIcon /><StarIcon /><StarIcon /><StarIcon />
//                             </div>
...
//                             </p>
//                             <div className="flex items-center gap-3 mt-4">
//                                 <img className="h-12 w-12 rounded-full object-cover" src="[https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=100&h=100&auto=format&fit=crop](https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=100&h=100&auto=format&fit=crop)" alt="userImage1"/>
//                                 <div>
//                                     <h2 className="text-lg text-slate-900 font-medium">Aman Chaudhary</h2>
//                                 </div>
//                             </div>
//                         </div>
...
//                              </p>
//                             <div className="flex items-center gap-3 mt-4">
//                                 <img className="h-12 w-12 rounded-full object-cover" src="[https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=100&h=100&auto=format&fit=crop](https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=100&h=100&auto=format&fit=crop)" alt="userImage2"/>
//                                 <div>
//                                     <h2 className="text-lg text-slate-900 font-medium">Prajwol Neupane</h2>
//                                 </div>
//                             </div>
//                         </div>
...
//                             </p>
//                             <div className="flex items-center gap-3 mt-4">
//                                 <img className="h-12 w-12 rounded-full object-cover" src="[https://www.mytalk1071.com/wp-content/uploads/2024/11/CMG0f2c85f7-b2a7-4ff7-99ca-0a3f9d6b00c0-1.jpg](https://www.mytalk1071.com/wp-content/uploads/2024/11/CMG0f2c85f7-b2a7-4ff7-99ca-0a3f9d6b00c0-1.jpg)" alt="userImage3" onError={(e) => { e.target.onerror = null; e.target.src='[https://placehold.co/100x100/374151/ffffff?text=S](https://placehold.co/100x100/374151/ffffff?text=S)'; }}/>
//                                 <div>
//                                     <h2 className="text-lg text-slate-900 font-medium">Sydney Sweeney</h2>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
