...
//                         <div className="bg-white rounded-lg shadow-lg p-6 text-center transform hover:scale-105 transition-transform duration-300 hover:ring-2 hover:ring-blue-500">
//                             <FeatureIcon><WrenchIcon /></FeatureIcon>
//                             <h3 className="text-xl font-bold mb-2 text-blue-600">Expert Technicians</h3>
...
//                         <div 
//                             className="group relative rounded-lg shadow-lg h-48 transform transition-transform duration-300 hover:scale-105 bg-cover bg-center overflow-hidden"
...
//                                 <p className="text-gray-200 text-sm transition-all duration-300 ease-in-out opacity-0 max-h-0 group-hover:max-h-40 group-hover:opacity-100 group-hover:mt-2">
...
//                         <div className="w-80 flex flex-col items-start bg-white rounded-lg shadow-lg p-5 transform hover:scale-105 transition-transform duration-300 hover:ring-2 hover:ring-blue-500">
//                             <QuoteIcon />
...
//                                 <div>
//                                     <h2 className="text-sm text-black font-medium">Aman Chaudhary</h2>
//                                 </div>
//                             </div>
//                         </div>
//                         <div className="w-80 flex flex-col items-start bg-white rounded-lg shadow-lg p-5 transform hover:scale-105 transition-transform duration-300 hover:ring-2 hover:ring-blue-500">
...
//                                 <div>
//                                     <h2 className="text-sm text-black font-medium">Prajwol Neupane</h2>
//                                 </div>
//                             </div>
//                         </div>
//                         <div className="w-80 flex flex-col items-start bg-white rounded-lg shadow-lg p-5 transform hover:scale-105 transition-transform duration-300 hover:ring-2 hover:ring-blue-500">
...
//                                 <div>
//                                     <h2 className="text-sm text-black font-medium">Sydney Sweeney</h2>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
