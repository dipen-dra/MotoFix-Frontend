...
const MyPaymentsPage = () => {
    ...
    const [paidBookings, setPaidBookings] = useState([]); // New state for paid bookings
    const [isLoading, setIsLoading] = useState(true);
    ...
    const fetchBookings = async () => {
        ...
        try {
            ...
            // Filter bookings into paid and unpaid
    ...
    const handlePayment = async (bookingId, method) => {
        ...
        try {
            ...
            fetchBookings(); // Re-fetch all bookings to update both lists
        } catch (error) {
