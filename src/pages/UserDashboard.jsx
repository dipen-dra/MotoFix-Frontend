...
// const UserProfilePage = ({ currentUser, setCurrentUser }) => { // 1. Receive props
//     const [profile, setProfile] = useState({ fullName: '', email: '', phone: '', profilePicture: '' });
...
//             setInitialProfile(updatedData); // Update initial state
//             setCurrentUser(updatedData); // 2. Update parent state
//             setIsEditing(false);
...
//     const handleCancel = () => {
//         setProfile(initialProfile); // Revert to original state
//         setIsEditing(false);
//     };
...
//                         {/* 3. Corrected phone number display */}
...
//             // 4. Pass props to UserProfilePage
...
// import React, { useState, useEffect, useRef } from 'react';
// import { BarChart, LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
// import { LayoutDashboard, CalendarDays, User, LogOut, Menu, X, Sun, Moon, PlusCircle, Bike, Wrench, Edit, Trash2, AlertTriangle, Camera, MapPin } from 'lucide-react'; // Added MapPin
// import { toast } from 'react-toastify';
            ...
            (error) => {
                ...
                switch (error.code) {
                    ...
                    case error.POSITION_UNAVAILABLE:
                        message = "Location information is unavailable. This can happen on desktops without Wi-Fi. Please check your OS location settings.";
                        break;
                    case error.TIMEOUT:
