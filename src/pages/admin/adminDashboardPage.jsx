...
import { Plus, Edit, Trash2, Eye, Search, ChevronDown, ChevronUp, Users, Wrench, DollarSign, List, User, Settings, LogOut, Menu, X, Sun, Moon } from 'lucide-react';
                ...
                <Card className="hover:border-blue-500 border-2 border-transparent">
                    <div className="flex items-center gap-4">
                        <div className="p-3 bg-blue-100 dark:bg-blue-900 rounded-full">
                            <DollarSign className="text-blue-600 dark:text-blue-300" size={28}/>
                        </div>
                        <div>
                ...
                <Card className="hover:border-green-500 border-2 border-transparent">
                     <div className="flex items-center gap-4">
                        <div className="p-3 bg-green-100 dark:bg-green-900 rounded-full">
                            <List className="text-green-600 dark:text-green-300" size={28}/>
                        </div>
                        <div>
                ...
                <Card className="hover:border-indigo-500 border-2 border-transparent">
                     <div className="flex items-center gap-4">
                        <div className="p-3 bg-indigo-100 dark:bg-indigo-900 rounded-full">
                            <Users className="text-indigo-600 dark:text-indigo-300" size={28}/>
                        </div>
                        <div>
                        ...
                        <tbody>
                            {mockBookings.slice(0, 5).map(booking => (
                                <tr key={booking.id} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                                    <td className="p-3 font-medium text-gray-900 dark:text-white">{booking.customerName}</td>
                                    <td className="p-3 text-gray-600 dark:text-gray-300">{booking.serviceType}</td>
                                    <td className="p-3">
                                        <StatusBadge status={booking.status} />
                                    </td>
                                    <td className="p-3 text-gray-600 dark:text-gray-300">{booking.date}</td>
                        ...
                        <tbody>
                            {filteredBookings.map(booking => (
                                <tr key={booking.id} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                                    ...
                                    <td className="p-3 text-right font-medium">₹{booking.totalCost}</td>
                                    <td className="p-3 text-center">
                                        <div className="flex justify-center items-center gap-2">
                                            ...
                                            <button onClick={() => handleDelete(booking.id)} className="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 p-1"><Trash2 size={18} /></button>
                                        </div>
                                    </td>
                                </tr>
                            ))}
    ...
    useEffect(() => {
        if (booking) {
            setFormData({
             ...
             setFormData({ status: 'Pending', totalCost: 0 });
        }
    }, [booking]);
        ...
        <Modal isOpen={isOpen} onClose={onClose} title={booking ? `Edit Booking #${booking.id}` : 'New Booking'}>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <select id="status" name="status" value={formData.status || ''} onChange={handleChange} className="w-full mt-1 px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg">
                        ...
                        <tbody>
                            {filteredUsers.map(user => (
                                <tr key={user.id} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                                    ...
                                    <td className="p-3 text-gray-600 dark:text-gray-300">{user.phone}</td>
                                    <td className="p-3 text-gray-600 dark:text-gray-300">{user.dateJoined}</td>
                                    <td className="p-3 text-center font-medium">{user.totalBookings}</td>
                                    <td className="p-3 text-center">
                                         <button onClick={() => handleDelete(user.id)} className="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 p-1"><Trash2 size={18} /></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
                    ...
                    <Card key={service.id} className="flex flex-col">
                        ...
                        <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                             ...
                             <div className="flex gap-2">
                                 ...
                                 <button onClick={() => handleDelete(service.id)} className="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 p-2 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600"><Trash2 size={18} /></button>
                             </div>
                        </div>
                    </Card>
                ))}
