...
//                 <p className="mt-4 text-base text-gray-500">Subscribe for updates.</p>
...
//             <p className="text-base text-black xl:text-center">&copy; {new Date().getFullYear()} MotoFix. All rights reserved.</p>
//         </div>
//       </div>
//     </footer>
//   );
